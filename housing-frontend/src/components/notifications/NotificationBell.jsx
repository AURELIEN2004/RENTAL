...
import { useNavigate } from 'react-router-dom';
import './NotificationBell.css';
import { FaTimes } from 'react-icons/fa'; // <-- IL MANQUAIT CETTE LIGNE !
import { useTheme } from '../../contexts/ThemeContext';
...
const NotificationBell = () => {
  ...
  return (
    <div className="notification-bell-container" ref={dropdownRef}>
      ...
      {showDropdown && (
        <div className="notification-dropdown">
          {/* Bouton de fermeture rapide uniquement visible sur mobile pour la fluidité UX */}
          <button className="mobile-close-notif" onClick={() => setShowDropdown(false)}>
            <FaTimes />
          </button>
