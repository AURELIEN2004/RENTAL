      ...
      <div className="container">
        ...
        <section className="about-section">
          ...
          <div className="innovation-grid">
            {[
              {
                icon: <FaDna />,
                title: t('innov_genetic'),
                desc: t('innov_genetic_desc'),
              },
              {
                icon: <FaMapMarkedAlt />,
                title: t('innov_geo'),
                desc: t('innov_geo_desc'),
              },
              {
                icon: <FaComments />,
                title: t('innov_msg'),
                desc: t('innov_msg_desc'),
              },
              {
                icon: <FaMobileAlt />,
                title: t('innov_mobile'),
                desc: t('innov_mobile_desc'),
              },
            ].map((item, i) => (
              <div key={i} className="innovation-card">
                <div className="icon">{item.icon}</div>
        ...
        <section className="about-section values-section">
          ...
          <div className="values-grid">
            {[
              {
                title: t('val_transparency'),
                desc: t('val_transparency_d'),
              },
              {
                title: t('val_trust'),
                desc: t('val_trust_d'),
