...
# ============================================
# 📁 config/settings.py - MISE À JOUR
# ============================================
# 
# AJOUTEZ CES MODIFICATIONS À VOTRE FICHIER settings.py EXISTANT
#
...
INSTALLED_APPS = [
    ...
    'apps.visits',
    'apps.notifications',
    'apps.recherche',  # ✅ NOUVEAU - Application de recherche intelligente
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'feudjioaurelien24@gmail.com'
EMAIL_HOST_PASSWORD = '15012004Fa'
DEFAULT_FROM_EMAIL = 'Housing Platform <feudjioaurelien24@gmail.com>'
...
# ============================================
# ✅ NOUVEAU - Configuration OpenAI (Optionnelle)
# ============================================
...
# Clé API OpenAI (optionnelle - le système fonctionne avec fallback si absente)
OPENAI_API_KEY = os.getenv('OPENAI_API_KEY', None)

# Si vous n'avez pas de clé OpenAI, le système utilisera l'extraction par règles regex
